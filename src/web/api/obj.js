export default {
  list: (project, type) => {
    return axios.get(`/api/project/${project}/type/${type}/list`)
      .then(response => response.data);
  },

  load(project, type, id) {
    if (type == 'detail')
      return axios.get(`/api/project/${project}/detail/${id}`)
        .then(response => response.data);

    return axios.get(`/api/project/${project}/type/${type}/object/${id}`)
      .then(response => response.data);
  },
